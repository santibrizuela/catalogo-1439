...
import BannerBrand from '@/public/jmevLogo.svg';
...
const Carousel = () => {
    return ( 
        <div className="bg-cover bg-center md:bg-fixed" style={{ backgroundImage: "url('../../../1018_AFS_Supoeracción_20251028 1FS03786.jpg')"}}>
