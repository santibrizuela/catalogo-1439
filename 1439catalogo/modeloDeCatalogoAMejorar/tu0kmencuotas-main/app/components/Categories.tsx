...
// img
import Img1 from '@/public/__1.jpg';
import Img4 from '@/public/__2.jpg';
import Img7 from '@/public/__11.jpg';
                    ...
                    {/* image */}
                        <div className='group relative overflow-hidden text-start
                         rounded-xl'>
                            ...
                            {/* img */}
                            <Image 
                            className='group-hover:scale-125 transition-all duration-500 w-full object-cover max-h-[400px]' 
                            src={cardimage} 
